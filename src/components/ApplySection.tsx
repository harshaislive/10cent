      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-12 border border-white/20 mb-12">
            ...
            <a
              href="#"
              className="inline-block px-12 py-4 bg-amber-600 text-white font-serif text-lg tracking-wide hover:bg-amber-700 transition-all duration-300 transform hover:scale-105"
            >
              Apply Now
            </a>
          </div>
