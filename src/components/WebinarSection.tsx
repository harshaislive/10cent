...
export default function WebinarSection() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setShowFloatingCTA(heroScrolledPast && !accessVisible)
    }
        ...
        {/* Two Column Layout: Not For vs For - Moved Closer to Top */}
          <div className="max-w-4xl mx-auto mb-6">
            ...
            <div>
              ...
              <p className="text-text-secondary mb-4 font-arizona text-sm">
                Ready to question whether your success is serving your life, not the other way around. Willing to sit with discomfort if it leads to clarity.
              </p>
