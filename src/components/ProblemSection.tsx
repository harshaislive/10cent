            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="relative pl-8 border-l-2 border-orange-500/30">
                  ...
                  <div className="text-6xl md:text-7xl font-arizona font-light text-orange-500 mb-2 flex items-center justify-center">
                    <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-full h-full">
