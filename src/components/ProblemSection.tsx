    ...
    <section id="problem" ref={ref} className="section-padding relative overflow-hidden">
      ...
      <div className="container-max relative z-10">
        ...
        <div className="mt-8 relative">
          {/* Background accent */}
          <div className="absolute inset-0 bg-gradient-to-r from-brand-red/5 via-transparent to-sustainable-green/5 pointer-events-none"></div>
          
          <div className="max-w-7xl mx-auto px-8 relative">
            {/* Section header with dramatic typography */}
            <div className="mb-8">
              <div className="flex items-center justify-between mb-8">
                <div className="w-32 h-px bg-brand-red"></div>
                <div className="w-32 h-px bg-sustainable-green"></div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
              ...
              <div className="lg:col-span-7">
                <div className="relative">
                  {/* Decorative element */}
                  <div className="absolute -top-12 -left-8 w-24 h-24 border-4 border-brand-red/20 rounded-full"></div>
      ...
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <div className="absolute top-20 right-20 w-64 h-64 bg-brand-red rounded-full blur-3xl" />
